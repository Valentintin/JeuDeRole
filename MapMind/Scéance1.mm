...
<node TEXT="Première scéance" FOLDED="false" ID="ID_131828189" CREATED="1678040390552" MODIFIED="1678294257391" LINK="Jeu%20De%20Rôle.mm"><hook NAME="MapStyle" background="#2e3440" zoom="1.132">
...
<node TEXT="1.1 Intro: Nous commençons notre aventure à Tullta, port de marchandise important du Royaume de Illina.&#xa;Vous vous êtes fait enrôler dans la milice récemment qui embauche à tour de bras.&#xa;Ville des opportunités vous ne savez pas combien de temps vous resterez des apprentis&#xa;le travail paye bien et globalement après 1 mois de Travail ensemble des liens d&apos;amitiés&#xa;se sont fait entre vous. Même votre instructeur George qui vous a invité à manger ce&#xa;midi dans l&apos;Auberge de Franz bien connu pour ses fameux burritos." POSITION="right" ID="ID_686812129" CREATED="1678302905906" MODIFIED="1678303090653">
<node TEXT="george prend la parole:&#xa;qui êtes vous en vrai ?&#xa;&#xa;George lance un pari de boisson au groupe&#xa;celui qui enchaine le plus vite les pintes de bière" ID="ID_1008767109" CREATED="1678303285721" MODIFIED="1678303472346"><richcontent CONTENT-TYPE="xml/" TYPE="DETAILS">
<html>
  <head>
  ...
  <body>
    <p>
      présentation des personnage par ordre de charisme
    </p>
    <p>
      
    </p>
    <p>
      difficulté /10 introduction au test de constitution.
    </p>
    <p>
      Celui qui pert aura un malus -1 pour tout ses jets.
    </p>
  </body>
</html></richcontent>
<node TEXT="Les burritos arrivent tout chaud Franz prend la parole" ID="ID_28459859" CREATED="1678303425328" MODIFIED="1678303514403"><richcontent CONTENT-TYPE="xml/" TYPE="DETAILS">
<html>
  <head>
  ...
  <body>
    <p>
      d6&gt;1 pour voir si des burritos ne passe pas alors malus -1 sur constitution
    </p>
  </body>
</html></richcontent>
<node TEXT="Franz repart dans ses cuisines. 20 minutes passent puis soudain vous entendez un cri de douleur Franz et au même moment vous voyez quelq&apos;un prendre la fuite en courrant. Que faites-vous ?" ID="ID_581774826" CREATED="1678303487598" MODIFIED="1678303655434"><richcontent CONTENT-TYPE="xml/" TYPE="DETAILS">
<html>
  <head>
  ...
  <body>
    <p>
      5 secondes de reflexions avant que rattraper le fuyard ne soit plus possible
    </p>
  </body>
</html></richcontent>
</node>
